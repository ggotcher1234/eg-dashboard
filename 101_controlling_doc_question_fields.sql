...
-- dropped and each question is now three explicit fields on the internal
-- form:
--
--   question               -- the question itself (unchanged column; still
--                              what shows on the EG Research Reports page)
--   background              -- context / elaboration (internal only)
--   customer_ranking_notes  -- customer ranking + notes (internal only)
--
-- The two new columns are internal to the Controlling Document form --
...
alter table client_research_questions add column if not exists customer_ranking_notes text;
